...
namespace MechanicWebService.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var appDbContext = _context.Payments.Include(p => p.Reservation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,ReservationId,PaymentMethod,Amount")] Payment payment)
        {
